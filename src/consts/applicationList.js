...
export const applicationList = [
  {
    description:'基于深度学习模型DeepLabV3P实现高精度车道线检测,使用的数据集为城市道路交通流数据',
    backgroundUrl:
  ...
  {
    description:'本系统首先针对交通系统运行与环境效益分离的问题，研究不同交通状态对交通环境的影响规律，同时，基于环境对交通需求的制约机制挖掘交通状态及交通环境的耦合关系。并研究大数据驱动的交通及环境重大事件的感知、辨识、预测、影响分析与应急响应，进而，提出基于交通与环境态势的协同决策方案，并基于路网动态排放实时监测平台实现本课题的决策应用。',
    backgroundUrl:
        'https://i2.100024.xyz/2023/05/04/ivlqpm.webp',
    heat: 115989,
    data: ['城市道路交通流数据'],
    name: '地铁客流可视化系统',
    link: 'http://8.140.124.245:38080/#/',
  ...
  {
    description:'本系统是一个基于大数据的城市交通平行验证与分析系统——针对城市交通管理面临的操作对象过于复杂、实验难以开展等难题，通过构建实际交通系统与人工交通系统之间交互运行和过程演化的“平行系统”，实现对现实交通系统管理和控制方案的仿真、评估和优化，为基于大数据的城市交通一体化协同技术集成与综合应用示范提供实验支持，减少我国城市交通规划、设计、建设和管理中的盲目性。',
    backgroundUrl:
        'https://i2.100024.xyz/2023/05/04/j076yv.webp',
    heat: 11589,
    data: ['城市道路交通流数据'],
    name: '疫情防控应急系统',
  ...
  {
    description:'本项目形成城市交通出行大数据实时可视化分析平台，利用交通流一致的交通视频实时协同仿真技术，依托于“天河二号”超算平台，搭建了基于Spark的百万级轨迹数据的分析系统。',
    backgroundUrl:
        'https://i2.100024.xyz/2023/05/04/j2rovg.webp',
    heat: 24613,
    data: ['城市道路交通流数据'],
    name: '交通线网可视化系统',
  ...
  {
    description:'本系统探究了复杂交通系统的交通要素与特征内在耦合机理，面向交通出行行为分析研究了出行属性分布特征，提出了基于社会关联性的交通同行行为检测方法和出行关联强度分析方法，并构建出行行为的联合概率加权模型实现出行规律发现。',
    backgroundUrl:
      'https://i2.100024.xyz/2023/05/04/ittmym.webp',
    heat: 39241,
    data: [
      '深圳出租车GPS数据',
      '中山大学—车道线检测数据集',
