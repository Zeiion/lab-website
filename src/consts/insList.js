...
export const insList = [
  ...
  },
  {
    ...
    description:
      '北京工业大学是一所以工为主，工、理、经、管、文、法、艺术、教育相结合的多科性市属重点大学，是国家“世界一流学科建设高校”、国家“211工程”建设高校；大连理工大学（Dalian University of Technology）简称”大工“，坐落于大连，是中华人民共和国教育部直属的全国重点大学...',
    owner_phone: '12345678910',
  ...
  },
  {
    support_faculty: 0,
    data_detail_id: [],
    owner_name: '香港科大霍英东研究院',
    description:
      '香港科技大学霍英东研究院（HKUST Fok Ying Tung Research Institute）由霍英东基金会捐建，于2007年1月正式落户广州南沙，是南沙首家香港背景科研机构。研究院依托香港科技大学领先国际的科研及教育优势，致力于创新科技研发与成果转化，重点布局物联网、先进制造与自动化、先进材料、绿色建筑与环境等领域的研发工作，并为内地经济发展培养具有创新思维和国际视野的高端科技人才。',
    owner_phone: '12345678910',
    ...
    user_count: 1,
    model_count: 0,
    name: '香港科大霍英东研究院交通大数据组',
    contract_count: 0,
    iconUrl:
      'http://8.140.124.245:8129/mnt/deploy/resource/faculty-logo/94ba74647747e5deb1dc2dc3ae4681b8.png',
    index_identify_id: '',
    data_count: 0,
    support_app: 0,
    node_id: 7,
