...
export const parseModelList = () => {
  const list = modelList.map((item) => {
    return {
      ...
      date: item.publish,
      // href:`http://www.feiyun.tech:82/#/manage/model/detail/${item.id}`,
      href: '/model/' + item.id,
      source: item.source,
    };
  });
...
export const modelList = [
  ...
  },
  {
    ...
    support: 3,
    description:
      '使用用于行车道检测学术研究的大规模具有挑战性的CULane数据集进行实验',
    tags: ['交通', '目标预测', '交通事故'],
  },
  {
    date: 1654521438000,
  ...
  },
  {
    ...
    support: 1,
    description:
      '注意力人群流量机，能推断人群流量，通过注意力机制学习随时间变化数据的动态表示。Lingbo Liu，Ruimao Zhang，Jiefeng Peng，Guanbin Li，Bowen Du，and Liang Lin.2018. Attentive Crowd Flow Machines. In ACM Multimedia. ACM，1553–1561.',
    tags: ['交通', '图卷积', '自动化'],
  },
  {
    date: 1644067342000,
    ...
    support: 2,
    description:
      '自适应图卷积循环网络，通过自适应模块增强传统图卷积，并组合成循环神经网络，以捕捉细粒度时空关联。Lei Bai，Lina Yao，Can Li，Xianzhi Wang，and Can Wang. 2020. Adaptive Graph Convolutional Recurrent Network for Traffic Forecasting. In NeurIPS.',
    tags: ['交通', '预测', '交通事故'],
  },
  {
    date: 1641388946000,
    ...
    support: 1,
    description:
      '基于注意力的时空图卷积网络，融合时空注意力机制与时空卷积捕捉动态时空特征。Shengnan Guo，Youfang Lin，Ning Feng，Chao Song，and Huaiyu Wan. 2019.Attention Based Spatial-Temporal Graph Convolutional Networks for Traffic Flow Forecasting. In AAAI. AAAI Press，922–929.',
    tags: ['交通', '目标预测', '结构健康监测'],
  },
  {
    date: 1628169751000,
    ...
    support: 1,
    description:
      '时空残差网络，广泛用于基于网格的流量预测任务，以残差单元建模时空关联。Junbo Zhang，Yu Zheng，and Dekang Qi. 2017. Deep Spatio-Temporal Residual Networks for Citywide Crowd Flows Prediction. In AAAI. AAAI Press，1655–1661.',
  ...
  },
  {
    ...
    support: 0,
    description:
      '扩散卷积循环神经网络，用由扩散过程形式化的图卷积捕捉时间依赖，并用编码器-解码器框架捕捉空间依赖。Yaguang Li，Rose Yu，Cyrus Shahabi，and Yan Liu. 2018. Diffusion Convolutional Recurrent Neural Network: Data-Driven Traffic Forecasting. In ICLR (Poster).OpenReview.net.',
    tags: ['交通', '图卷积', '自动化'],
  },
  {
    date: 1612617766000,
    ...
    support: 0,
    description:
      '交通速度预测模型，时空图卷积网络，综合图卷积和门控时间卷积捕捉时空关联。Bing Yu，Haoteng Yin，and Zhanxing Zhu. 2018. Spatio-Temporal Graph Convolutional Networks: A Deep Learning Framework for Traffic Forecasting. In IJCAI. ijcai.org，3634–3640.',
    tags: ['交通', '预测', '交通事故'],
  },
];
