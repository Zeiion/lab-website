export const teamInfo = {
  title: '北航计算机学院交通大数据组',
  description:
    '北航计算机学院交通大数据组主要针对我国综合交通跨行业、跨地域管理服务能力不足等问题，建设综合交通大数据应用技术创新平台，支撑开展交通运输大数据采集处理、分析挖掘、管理决策、融合应用等技术的研发和工程化。为大数据驱动的综合交通运输规划、大型综合交通枢纽协同运行组织与优化、城市群综合交通系统运行监测与服务、综合交通智慧出行协同运行研发、综合交通系统能耗排放分析与节能服务、综合交通系统运行安全与应急保障等综合交通大数据应用提供技术、平台支撑；产出各类科技专利、标准、建议与工程产品原型；在国家层面提高支撑开展综合交通大数据应用的研究、服务和应用推广工作的能力；积极进行产业合作，包括软硬件销售、集成开发及公益服务；培养综合交通大数据应用技术和管理人才。',
  researchDirections: [
    '时空大数据挖掘',
    '人工智能',
    '交通大数据',
  ...
  contactInfo: 'dbw@buaa.edu.cn',
  iconUrl: 'http://81.70.246.244:9126/i/2023/04/14/bygr9.webp',
  members: [
    {
      name: '吕卫锋',
      description:
        '教授、博士生导师。 1998年博士毕业于北京航空航天大学计算机系。现任北京航空航天大学副校长，软件开发环境国家重点实验室副主任。目前是国家标准委员会专家组成员，国家科技平台标准化技术委员会委员，北京市信息化专家咨询委员会委员，中国电子学会理事会理事。中国软件协会副理事长、秘书长。主要研究方向：海量数据处理、算法及大型信息系统开发方法.主要从事大数据挖掘理论与智慧城市应用研究工作。近年来先后主持完成国家973计划、863计划和航空基金等国家级研究与工程项目十余项，包括国家科技部863计划智慧城市 “城市多模式数据系统互联技术与支撑环境”课题等。开展面向城市海量多源数据挖掘与应用、多领域大型信息系统开发方法及理论等方面研究，已发表SCI/EI学术论文40余篇，国家发明专利6项 。在教学方面多年担任计算机学院本科生与研究生的主讲教师，现为北航计算机学院研究生开设“程序设计语言原理与实践”学位课程，为本科生开设“离散数学”学位课程。并作为第二作者编写、出版了高等学校计算机教材丛书“程序设计语言原理”教材一部。获国家科技发明二等奖1项，国家科技进步二等奖1项，省部级科学技术一等奖3项。',
      imgSrc: 'http://81.70.246.244:9126/i/2023/05/08/gnnfsz.webp',
      tags: ['教授', '博士生导师'],
      works: [
        {
          title:
    ...
    //   imgSrc: "http://81.70.246.244:9126/i/2023/05/08/h3t97z.webp",
    //   tags: [
    //     "副教授",
    //     "博士生导师"
    //   ],
  ...
  works: [
    {
      ...
      description:
        '提出的模型在两个多任务基线数据集：Climate和Sarcos，以及一个真实数据集Dianping上进行实验验证。实验验证结果表明，提出的方法能够利用任务和特征之间的多种关系来提高多任务模型的预测性能。',
      imgSrc: 'http://81.70.246.244:9126/i/2023/04/13/1224nzy.webp',
      tags: ['多任务学习', '多关系建模'],
      author: 'Jiejie Zhao, Bowen Du, Leilei Sun',
      authorImgSrc: 'http://81.70.246.244:9126/i/2023/05/08/h2ncfy.webp',
      date: '2019-01',
      href: 'https://dl.acm.org/doi/abs/10.1145/3292500.3330861',
    },
    {
      title:
        'A graph attention fusion network for event-driven traffic speed prediction',
      description:
        '提出了一个名为事件感知图注意力融合网络的新框架。提出了一个 SEE 块来学习事件的直接空间相关性。.',
      imgSrc: 'http://81.70.246.244:9126/i/2023/04/13/127hk28.webp',
      tags: ['图注意力网络', '特征融合'],
    ...
    },
    {
      ...
      description:
        '在本文中提出了一种级联深度生成对抗网络 (GAN)，其灵感来自于城市专家的工作流程。第一个 GAN 是根据人类指令和周围环境构建城市功能区。第二个 GAN 将通过考虑已建成的城市功能区来产生土地利用配置。',
      imgSrc: 'http://81.70.246.244:9126/i/2023/04/14/qha1xt.webp',
      tags: ['自动化城市规划', '空间层次结构'],
  ...
  timeline: [
    ...
    },
    {
      ...
      description: '国家技术进步二等奖',
      tags: ['HTML5', 'CSS3', 'JavaScript', 'jQuery', 'Wordpress', 'Test'],
    },
    {
      title: '国际期刊/会议学术论文70余篇',
      type: '学术成果',
      date: '2022 Oct 4',
      dateRange: 'June 2016 - Present',
      description:
        '包括KDD、AAAI、SIGMOD、TKDE、Networks、TC等国际期刊/会议学术论文70余篇，其中CCF A类（或JCR Q1）论文30余篇，授权发明专利10余项',
      tags: ['国际期刊', '会议论文', '发明专利'],
    },
  ],
  imgSrc: 'http://81.70.246.244:9126/i/2023/04/03/12t396m.webp',
  tags: ['科研院校', '交通大数据'],
  author: '北航计算机学院交通大数据组',
  authorImgSrc:
    'http://8.140.124.245:8129/mnt/deploy/resource/faculty-logo/31b2afe97919a416e92e0e9ee7516a10.jpg',
  date: '2022-07-04 18:30:29',
  href: '',
};
