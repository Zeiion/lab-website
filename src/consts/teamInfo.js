export const teamInfo = {
    title: "北航计算机学院交通大数据组",
    description: "北航计算机学院交通大数据组主要针对我国综合交通跨行业、跨地域管理服务能力不足等问题，建设综合交通大数据应用技术创新平台，支撑开展交通运输大数据采集处理、分析挖掘、管理决策、融合应用等技术的研发和工程化。为大数据驱动的综合交通运输规划、大型综合交通枢纽协同运行组织与优化、城市群综合交通系统运行监测与服务、综合交通智慧出行协同运行研发、综合交通系统能耗排放分析与节能服务、综合交通系统运行安全与应急保障等综合交通大数据应用提供技术、平台支撑；产出各类科技专利、标准、建议与工程产品原型；在国家层面提高支撑开展综合交通大数据应用的研究、服务和应用推广工作的能力；积极进行产业合作，包括软硬件销售、集成开发及公益服务；培养综合交通大数据应用技术和管理人才。",
    researchDirections: [
      "时空大数据挖掘",
      "人工智能",
      "交通大数据",
    ...
    collaborationIntro: "我们团队由两位经验丰富的技术专家担任领头人，拥有丰富的科研经验，多年的软件开发和技术管理能力。团队成员结构包括10位博士、40余位硕士和90余位本科生，涵盖了软件开发、交通大数据科学、人工智能等多个领域。我们团队成员均来自北京航空航天大学的优秀学生，拥有各种专业技能和技术能力，包括程序设计、算法开发、数据库设计和管理等。我们的团队成员拥有的各种头衔，包括但不限于教授、高级工程师、架构师等。我们的团队注重技术创新和学习，积极研究新技术、新方法和新工具，以提供更优秀的解决方案。",
    ...
    members: [
      ...
      },
      {
        ...
        works: [
          ...
          {
            title: "A graph attention fusion network for event-driven traffic speed prediction",
    ...
    works: [
      {
        title: "Multiple relational attention network for multi-task learning",
        description: "提出的模型在两个多任务基线数据集：Climate和Sarcos，以及一个真实数据集Dianping上进行实验验证。实验验证结果表明，提出的方法能够利用任务和特征之间的多种关系来提高多任务模型的预测性能。",
        imgSrc: "https://i2.100024.xyz/2023/04/13/1224nzy.webp",
        tags: [
          "多任务学习",
          "多关系建模"
        ],
      ...
      {
        title: "A graph attention fusion network for event-driven traffic speed prediction",
        description: "提出了一个名为事件感知图注意力融合网络的新框架。提出了一个 SEE 块来学习事件的直接空间相关性。.",
        imgSrc: "https://i2.100024.xyz/2023/04/13/127hk28.webp",
        tags: [
          "图注意力网络",
          "特征融合"
        ],
      ...
      },
      {
        ...
        description: "在本文中提出了一种级联深度生成对抗网络 (GAN)，其灵感来自于城市专家的工作流程。第一个 GAN 是根据人类指令和周围环境构建城市功能区。第二个 GAN 将通过考虑已建成的城市功能区来产生土地利用配置。",
        imgSrc: "https://i2.100024.xyz/2023/04/14/qha1xt.webp",
        tags: [
          "自动化城市规划",
          "空间层次结构"
        ],
    ...
    timeline: [
      ...
      },
      {
        ...
        date: "2022 Oct 4",
        dateRange: "June 2016 - Present",
        description: "包括KDD、AAAI、SIGMOD、TKDE、Networks、TC等国际期刊/会议学术论文70余篇，其中CCF A类（或JCR Q1）论文30余篇，授权发明专利10余项",
        tags: [
          "国际期刊",
          "会议论文",
          "发明专利"
    ...
    imgSrc: "https://i2.100024.xyz/2023/04/03/12t396m.webp",
    tags: [
      "科研院校",
      "交通大数据"
    ],
    author: "北航计算机学院交通大数据组",
    authorImgSrc: "http://8.140.124.245:8129/mnt/deploy/resource/faculty-logo/31b2afe97919a416e92e0e9ee7516a10.jpg",
