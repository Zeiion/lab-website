  ...
  const sceneList = [
    {
      ...
      imgSrc: 'http://39.97.209.211:9126/i/2023/03/28/sylh26.webp',
    ...
    },
    {
      ...
      imgSrc: 'http://39.97.209.211:9126/i/2023/03/28/sy59mk.webp',
      href: 'https://www.baidu.com',
    },
    {
      title: '基于ETC的车辆轨迹追踪',
      ...
      imgSrc: 'http://39.97.209.211:9126/i/2023/03/28/tuzimw.webp',
      href: 'https://www.baidu.com',
    },
    {
      title: '高速公路ETC知识图谱',
      ...
      imgSrc: 'http://39.97.209.211:9126/i/2023/03/28/tu916b.webp',
      href: 'https://www.baidu.com',
    },
    {
      title: '分布式区块链技术应用',
      description: `这是一个基于区块链技术的分布式系统，可用于交易、数据、日志、合约、成果的可信化共享以及存储`,
      imgSrc: 'http://39.97.209.211:9126/i/2023/03/28/sxmdg0.webp',
      href: 'https://www.baidu.com',
    },
  ];
  return (
    <PageTemplate title="典型场景" subTitle="Typical Scenarios">
      ...
      <TopicSection
        title="场景列表"
        description="This is the list of typical scenes, you can click the card to view the details of the scene. All the scenes are contributed by other teams."
        subTitle="Scene List"
        list={scenes2}
      />
    </PageTemplate>
