...
const StickyTextCard = ({ title, list = [] }) => {
  ...
  return (
    <section className="section-card-view" data-component="sticky-text-card">
      <div className="sticky-wrapper">
        <div
          className="mb-20 text-center opacity-40 sticky-title"
          ref={titleRef}
        >
          {title}
        </div>
