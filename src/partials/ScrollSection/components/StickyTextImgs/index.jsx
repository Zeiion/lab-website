...
const StickyTextImgs = ({ texts = [], subTexts = [], imgSrc = [] }) => {
  ...
  return (
    <section className="section-text-view" data-component="sticky-text-imgs">
      <div className="sticky-wrapper">
        <div className="sticky-content" ref={wrapperRef}>
          <div className="section-wrapper">
            ...
            <div className="opacity-0 section-text-wrapper" ref={text1Ref}>
            ...
            <div className="opacity-0 section-text-wrapper" ref={text2Ref}>
              {subTexts.map((subText, index) => (
                <h2
                  className="mt-40 opacity-0 h2 show-text-2"
                  style={{
                    left: -effectOffset,
                  }}
