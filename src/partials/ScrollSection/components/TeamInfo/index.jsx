            ...
            <div className="sticky-wrapper">
                <div className="sticky-content" ref={wrapperRef}>
                    <div className="section-wrapper">
                        ...
                        <div className="grid items-start max-w-sm gap-8 mx-auto md:grid-cols-1 lg:grid-cols-3 lg:gap-x-1 lg:gap-y-4 md:max-w-2xl lg:max-w-none gap-y-10 gap-x-4" ref={text1Ref}>

                                    <h2 className="opacity-0 h2 show-text">
                                        {text}
                                    </h2>
                                {teamInfo?.members &&
