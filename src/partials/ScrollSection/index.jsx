        ...
        <div className='py-12 md:py-20'>
          ...
          <div className='pb-12 mx-auto text-center md:pb-20 scroll-wrapper'>
            ...
            <StickyTexts
              headText='团队带头人'
              text={
                <div className='flex items-stretch h-48 gap-6 w-[36rem]'>
                  <img
                    src='http://scse.buaa.edu.cn/__local/4/79/41/C7E8D67ABE9448D65E35C15DDB8_41165F63_B8367.jpg'
                    className='flex flex-col object-cover w-48 h-48 rounded-full center'
                  />
                  <div className='flex-1 overflow-auto text-justify h4 opacity-80'>
                    杜博文，男，教授，博士生导师，国家自然科学基金委优秀青年基金获得者。2013年博士毕业于北京航空航天大学，曾在美国新泽西州立大学(Rutgers)做访问学者，现就职于软件开发环境国家重点实验室、综合交通大数据应用技术国家工程实验室及北京脑科学高精尖中心，主要研究方向为时空大数据挖掘、人工智能与工程大数据。
                  </div>
                </div>
              }
